...
/**
 * Note: source from http://code.google.com/p/deezapps-widgets/
...
{
   private final String TAG = "DeezApps.Widget.PagerControl";
   ...
   public PagerControl(Context context, AttributeSet attrs, int defStyle)
   {
      ...
      int highlightColor = a
            .getColor(R.styleable.com_deezapps_widget_PagerControl_highlightColor, DEFAULT_HIGHLIGHT_COLOR);
